...
public class WeatherRVAdapter extends RecyclerView.Adapter<WeatherRVAdapter.ViewHolder>{
    ...
    public void onBindViewHolder(@NonNull WeatherRVAdapter.ViewHolder holder, int position) {
        ...
        String icon_str= modal.getIcon();
        String url_param="https:";
        String full_url=String.valueOf(url_param+icon_str);
        Picasso.get().load(full_url).into(holder.conditionIV);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView){
            ...
            conditionIV = itemView.findViewById(R.id.idTVTCondition);
